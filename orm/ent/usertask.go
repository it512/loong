...
func (_m *UserTask) String() string {
	...
	builder.WriteString(_m.ActID)
	builder.WriteString(", ")
	builder.WriteString("act_name=")
	builder.WriteString(_m.ActName)
	builder.WriteString(", ")
